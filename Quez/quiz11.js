...
const showanswer_quiz = result_box.querySelector(".rButtons .showersult");
const quit_quiz = result_box.querySelector(".rButtons .quit");
...
function showanser(){
    ...
    if (r2[i][1].includes("Your answer is Correct 😎")) {
